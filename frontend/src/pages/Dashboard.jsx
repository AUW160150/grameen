...
const LOG_TIMELINE = [
  ...
  { t: 6300,  k: 'info',    txt: 'Contact Enricher: step 1 — Apify LinkedIn search for buyer profiles at matched companies…' },
  { t: 6500,  k: 'info',    txt: '[Apify] Query: site:linkedin.com/in "Anthropologie" (sourcing OR buyer OR procurement manager)' },
  { t: 6800,  k: 'apify',   company: 'Sarah Chen — Anthropologie',   segment: 'linkedin.com/in/sarah-chen-sourcing · VP Global Sourcing',  score: 0.94 },
  { t: 7000,  k: 'apify',   company: 'Marcus Webb — World Market',   segment: 'linkedin.com/in/marcus-webb · Ethical Goods Director',      score: 0.91 },
  { t: 7200,  k: 'info',    txt: '[Apify] Query: site:linkedin.com/in "Whole Foods Market" (sourcing OR buyer OR procurement)' },
  { t: 7400,  k: 'apify',   company: 'Priya Nair — Whole Foods',     segment: 'linkedin.com/in/priya-nair-wfm · Global Category Buyer',    score: 0.88 },
  { t: 7700,  k: 'success', txt: '[Apify] LinkedIn search complete · 12 profiles found across 4 companies' },
  { t: 8000,  k: 'info',    txt: 'Contact Enricher: step 2 — Apollo.io enrichment for emails + verified titles…' },
  { t: 8200,  k: 'info',    txt: '[Apollo.io] Enriching: company="Anthropologie" · roles=[sourcing manager, VP sourcing, category manager]' },
  { t: 8500,  k: 'enrich',  name: 'Sarah Chen',       title: 'VP Global Sourcing · Anthropologie',  email: 'apollo.io · s.chen@anthropologie.com (1 credit)' },
  { t: 8700,  k: 'enrich',  name: 'Marcus Webb',      title: 'Ethical Goods Dir. · World Market',   email: 'apollo.io · m.webb@worldmarket.com (1 credit)' },
  { t: 8900,  k: 'enrich',  name: 'Priya Nair',       title: 'Global Category Buyer · Whole Foods', email: 'apollo.io · p.nair@wholefoods.com (1 credit)' },
  { t: 9200,  k: 'success', txt: 'Contact enrichment complete · Apify LinkedIn profiles + Apollo.io emails · 38 contacts ready for outreach' },
  { t: 9500,  k: 'info',    txt: 'Outreach Agent: drafting personalized buyer pitches…' },
  { t: 9900,  k: 'email',   to: 'Sarah Chen', subject: 'Aarong handloom textiles — premium sourcing opportunity for Anthropologie' },
  { t: 10200, k: 'email',   to: 'Marcus Webb', subject: 'Artisan jamdani weaves from Bangladesh — World Market fit' },
  { t: 10500, k: 'email',   to: 'Priya Nair', subject: 'Certified organic wheat & moringa from Aarong cooperative network' },
  { t: 11000, k: 'success', txt: '24 personalized outreach emails sent · follow-up sequences queued at +3d, +7d' },
...
const AGENT_EVENTS = [
  ...
  { t: 9400,  agent: 'enrichment',  state: 'done' },
  { t: 9600,  agent: 'outreach',    state: 'running' },
  { t: 11200, agent: 'outreach',    state: 'done' },
